...
<div class="side-nav">
        ...
        echo "<ul>";
           ...
           foreach ($category as $cat) {
            ...
            echo "<li>";
            echo $this->Html->link($cat['Category']['category'], array('controller' => 'products', 'action' => 'sytrack', $cat['Category']['id']), array('update' => 'content'));
            echo "</li>";
               }
               else
               {
                   echo "<li>";
            echo $this->Html->link($cat['Category']['subcategory'], array('controller' => 'products', 'action' => 'sytrack', $cat['Category']['id']), array('update' => 'content'));
            echo "</li>";
               }
...
<div class="content">
   <div class='series-static'>
       <div class='series-image'>
          <?php echo $this->Html->image('syntrackproducts.jpg', array('alt' => 'logo')); ?>
       </div>

       <div class='series-text'>
            <div class="album1"> Syntrack </div>
