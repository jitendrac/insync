...
<div class="side-nav">
    ...
    foreach ($category as $cat) {
        echo "<li>";
        echo $this->Html->link($cat['Category']['category'], array('controller' => 'products', 'action' => 'saferetail', $cat['Category']['id']), array('update' => 'content'));
        echo "</li>";
    }
    echo "</ul>";
    ?>
...
<div class="content">
    <div class='series-static'>
        ...
        <div class='series-text'>
            <div class="album1"> Safe Retail </div>
